                            ...
                            <form action="/login" method="post">
                                ...
                                <div class="signup-input-area">
                                    ...
                                    <div class="signup-submit-button">
                                        <button class="button-hover" type="submit" >Login now</button>
                                    </div>
                                </div>
                            </form>

                            <div class="signup-bottom-text">
                                <p>By clicking Login Now, you accept the <a href="/legal">Terms and Conditions</a> and <a href="/legal">Privacy Policy</a> of Lynn Hosting.</p>
                            </div>
                        </div>
                    </div>
                </div>
